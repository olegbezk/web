 ...
 * @author Eugeny
 */
@WebServlet(name = "ViewStars", urlPatterns = {"/ViewStars"})
public class ViewStars extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List stars;
        if (idStr == null) {
            stars = starsSessionBean.listStars();
        } else {
            stars = starsSessionBean.listStars(Integer.parseInt(idStr));
        ...
        request.getRequestDispatcher("/viewstars.jsp").forward(request, response);
    }
