 ...
 * @author Eugeny
 */
@WebServlet(name = "AddConstellationSevlet", urlPatterns = {"/AddConstellation"})
public class AddConstellationSevlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        starsSessionBean.addConstellation(latinName, russianName);
